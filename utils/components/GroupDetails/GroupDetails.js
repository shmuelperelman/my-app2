...
import { getGroupPosts, deletePost, updatePost } from "@/utils/functions/apiCalls";
...
const GroupDetails = ({ groupId }) => {
  ...
  const fetchPosts = async () => {
    try {
      ...
      const fetchedPosts = await getGroupPosts(groupId, token);
          ...
          <div key={post._id} className="post">
            <div className="post-header">
              <img
                ...
                src={post.userDetails?.profilePictureURL}
              ...
              {getCookie("user_id") === post.user_id && (
              ...
              <div className="post-images">
                {post.images.map((image, index) => (
                  <div key={index} className="image-container">
                    ...
                    {getCookie("user_id") === post.user_id && (
                      <button
                        onClick={() => handleDeleteImage(post._id, image)}
